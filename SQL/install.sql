...
('Stock by Attributes - Lagerbestand bei den Varianten anzeigen', 'SBA_SHOW_STOCK_VARIANTS', 'Wollen Sie neben der Variantenauswahl den entsprechenden Lagerbestand anzeigen?',	43);